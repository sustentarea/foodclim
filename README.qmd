...
`rice` is a NetLogo model designed  to simulate and visualize the response of rice under different climate conditions. Its primary goal is to facilitate the integration of food agents into agent-based models and enhance the reproducibility of these simulations.
...
Vartanian, D., & Carvalho, A. M. (2025). *rice: Rice production in NetLogo* [Computer software, NetLogo model]. [https://doi.org/](https://doi.org/)
